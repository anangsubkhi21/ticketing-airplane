...
function checkout($data){
    ...
    mysqli_query($conn, $queryOrder);
     ...
     foreach ($_SESSION["cart"] as $id_tiket => $kapasitas) : ?>
        ...
        $sisaKursi = $tiket["kapasitas_kursi"] - $kapasitas;
        ...
        if($queryOrderDetail){
            $updateKursi = mysqli_query($conn, "UPDATE jadwal_penerbangan SET kapasitas_kursi = '$sisaKursi' WHERE id_jadwal = '$id_jadwal'");
        }
